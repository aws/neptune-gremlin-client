...
public class StatusEndpointFilter implements EndpointFilter {
    ...
    public Endpoint enrichEndpoint(Endpoint endpoint) {
        ...
        NeptunedataClient client;

        URI endpointUri = URI.create(String.format("https://%s:8182", endpoint.getAddress()));
        ...
        client = NeptunedataClient.builder()
        ...
        try {
            GetEngineStatusResponse engineStatus = client.getEngineStatus(GetEngineStatusRequest.builder().build());
